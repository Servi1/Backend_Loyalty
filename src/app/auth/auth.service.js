...
const getFavoriteBrandsDetails = async (brandIds) => {
  ...
  return tenants.map(t => ({
    ...
    hero: config.getAppImageURL(t.menuBannerUrl) || 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&h=400&fit=crop',
    bannerUrl: config.getAppImageURL(t.bannerUrl),
    bannerUrl2: config.getAppImageURL(t.bannerUrl2),
    bannerUrl3: config.getAppImageURL(t.bannerUrl3),
    slug: t.slug,
    isFavorite: true,
    cuisine: 'Restaurant',
  }));
